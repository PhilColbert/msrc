...
// Select RX protocol
#define RX_PROTOCOL RX_IBUS // RX_SMARTPORT, RX_XBUS, RX_SRXL, RX_IBUS
...
// Select sensors
#define CONFIG_ESC_PROTOCOL PROTOCOL_CASTLE // PROTOCOL_NONE, PROTOCOL_HW_V3, PROTOCOL_HW_V4_LV, PROTOCOL_HW_V4_HV, PROTOCOL_HW_V5_LV, PROTOCOL_HW_V5_HV, PROTOCOL_PWM, PROTOCOL_CASTLE, PROTOCOL_KONTRONIK
